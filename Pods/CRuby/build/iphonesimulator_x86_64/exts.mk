...
EXTOBJS = ext/extinit.o ext/bigdecimal/bigdecimal.a \
	  ...
	  ext/rbconfig/sizeof/sizeof.a ext/readline/readline.a \
	  ext/ripper/ripper.a ext/sdbm/sdbm.a ext/socket/socket.a \
	  ext/stringio/stringio.a ext/strscan/strscan.a \
	  ext/syslog/syslog.a ext/thread/thread.a ext/zlib/zlib.a
EXTLIBS = -lutil -ledit -lncurses -lz
EXTLDFLAGS = -Wl,-multiply_defined,suppress -L. -pipe -Os -isysroot \
	     ...
	     -L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator10.1.sdk/usr/lib \
...
ext/readline/readline.a: ext/readline/static
